...
set_property PACKAGE_PIN V13 [get_ports {gpio_led[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[8]}]
set_property PACKAGE_PIN V3 [get_ports {gpio_led[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[9]}]
set_property PACKAGE_PIN W3 [get_ports {gpio_led[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[10]}]
set_property PACKAGE_PIN U3 [get_ports {gpio_led[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[11]}]
set_property PACKAGE_PIN P3 [get_ports {gpio_led[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[12]}]
set_property PACKAGE_PIN N3 [get_ports {gpio_led[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[13]}]
set_property PACKAGE_PIN P1 [get_ports {gpio_led[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[14]}]
set_property PACKAGE_PIN L1 [get_ports {gpio_led[15]}]
set_property IOSTANDARD LVCMOS33 [get_ports {gpio_led[15]}]
